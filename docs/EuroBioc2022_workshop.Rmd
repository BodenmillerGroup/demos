...
40 proteins or RNA at 1μm resolution [@Giesen2014; @Schulz2018].
...
```{r spatial-viz-3, fig.height=12, fig.width=12, message=FALSE}
library(imcRtools)
library(ggplot2)
...
20-nearest neighbors and use kmeans clustering to group cells into 6 cellular
neighborhoods.
...
[detectSpatialContext](https://bodenmillergroup.github.io/imcRtools/reference/detectSpatialContext.html)
...
(here minimum of 100 cells) per SC with 
[filterSpatialContext](https://bodenmillergroup.github.io/imcRtools/reference/filterSpatialContext.html).
...
[plotSpatialContext](https://bodenmillergroup.github.io/imcRtools/reference/plotSpatialContext.html)
function to generate *SC graphs*, analogous to *CN combination maps* in
[@Bhate2022]. Returned objects are `ggplot` objects, which can be easily
...
```{r dist, fig.height=12, fig.width=12}
